...
define('ember-app/controllers/i-i-s-pencils-pencil-e', ['exports', 'ember-flexberry/controllers/edit-form'], function (exports, _editForm) {
  'use strict';
  ...
  exports.default = _editForm.default.extend({
    parentRoute: 'i-i-s-pencils-pencil-l'
  });
});
define('ember-app/controllers/i-i-s-pencils-pencil-e/new', ['exports', 'ember-app/controllers/i-i-s-pencils-pencil-e'], function (exports, _iISPencilsPencilE) {
  'use strict';
  ...
  var IISPencilsPencilENewController = _iISPencilsPencilE.default;
  exports.default = IISPencilsPencilENewController;
});
define('ember-app/controllers/i-i-s-pencils-pencil-l', ['exports', 'ember-flexberry/controllers/list-form'], function (exports, _listForm) {
  'use strict';
  ...
  exports.default = _listForm.default.extend({
    /**
      ...
      @type String
      @default 'i-i-s-pencils-pencil-e'
     */
    editFormRoute: 'i-i-s-pencils-pencil-e'
  });
});
...
define('ember-app/locales/en/forms/i-i-s-pencils-pencil-e', ['exports'], function (exports) {
  'use strict';
  ...
  exports.default = {
    caption: 'IISPencilsPencilE',
    'name-caption': 'name'
  };
});
define('ember-app/locales/en/forms/i-i-s-pencils-pencil-l', ['exports'], function (exports) {
  'use strict';
  ...
  exports.default = {
    caption: 'IISPencilsPencilL'
  };
});
define('ember-app/locales/en/models/i-i-s-pencils-pencil', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/translations', ['exports', 'ember-flexberry/locales/en/translations', 'ember-app/locales/en/forms/i-i-s-pencils-pencil-l', 'ember-app/locales/en/forms/i-i-s-pencils-pencil-e', 'ember-app/locales/en/models/i-i-s-pencils-pencil'], function (exports, _translations, _iISPencilsPencilL, _iISPencilsPencilE, _iISPencilsPencil) {
  'use strict';
  ...
  Ember.$.extend(true, translations, {
    models: {
      'i-i-s-pencils-pencil': _iISPencilsPencil.default
    },
    ...
    forms: {
      ...
      'i-i-s-pencils-pencil-l': _iISPencilsPencilL.default,
      'i-i-s-pencils-pencil-e': _iISPencilsPencilE.default
    }
...
define('ember-app/locales/ru/forms/i-i-s-pencils-pencil-e', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/forms/i-i-s-pencils-pencil-l', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/models/i-i-s-pencils-pencil', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/translations', ['exports', 'ember-flexberry/locales/ru/translations', 'ember-app/locales/ru/forms/i-i-s-pencils-pencil-l', 'ember-app/locales/ru/forms/i-i-s-pencils-pencil-e', 'ember-app/locales/ru/models/i-i-s-pencils-pencil'], function (exports, _translations, _iISPencilsPencilL, _iISPencilsPencilE, _iISPencilsPencil) {
  'use strict';
...
define('ember-app/mixins/regenerated/models/i-i-s-pencils-pencil', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  'use strict';
  ...
  var ValidationRules = exports.ValidationRules = {
    name: {
      descriptionKey: 'models.i-i-s-pencils-pencil.validations.name.__caption__',
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('PencilE', 'i-i-s-pencils-pencil', {
      name: (0, _attributes.attr)('Name', { index: 0 })
    });

    modelClass.defineProjection('PencilL', 'i-i-s-pencils-pencil', {
      name: (0, _attributes.attr)('Name', { index: 0 })
    });
  };
});
define('ember-app/mixins/regenerated/serializers/i-i-s-pencils-pencil-offline', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-pencils-pencil', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/models/custom-inflector-rules', ['exports', 'ember-inflector'], function (exports, _emberInflector) {
  ...
  inflector.irregular('pencil', 'Pencils');
...
define('ember-app/models/i-i-s-pencils-pencil', ['exports', 'ember-cp-validations', 'ember-flexberry-data/models/model', 'ember-flexberry-data/mixins/offline-model', 'ember-app/mixins/regenerated/models/i-i-s-pencils-pencil'], function (exports, _emberCpValidations, _model, _offlineModel, _iISPencilsPencil) {
  'use strict';
  ...
  var Validations = (0, _emberCpValidations.buildValidations)(_iISPencilsPencil.ValidationRules, {
    dependentKeys: ['model.i18n.locale']
  });

  var Model = _model.default.extend(_offlineModel.default, _iISPencilsPencil.Model, Validations, {});

  (0, _iISPencilsPencil.defineProjections)(Model);
...
define('ember-app/router', ['exports', 'ember-app/config/environment'], function (exports, _environment) {
  ...
  Router.map(function () {
    ...
    this.route('i-i-s-pencils-pencil-e', { path: 'i-i-s-pencils-pencil-e/:id' });
    this.route('i-i-s-pencils-pencil-e.new', { path: 'i-i-s-pencils-pencil-e/new' });
  });
...
define('ember-app/routes/i-i-s-pencils-pencil-e', ['exports', 'ember-flexberry/routes/edit-form'], function (exports, _editForm) {
  'use strict';
  ...
  exports.default = _editForm.default.extend({
    modelProjection: 'PencilE',
    modelName: 'i-i-s-pencils-pencil'
  });
});
define('ember-app/routes/i-i-s-pencils-pencil-e/new', ['exports', 'ember-flexberry/routes/edit-form-new'], function (exports, _editFormNew) {
  'use strict';
  ...
  exports.default = _editFormNew.default.extend({
    modelProjection: 'PencilE',
    modelName: 'i-i-s-pencils-pencil',
    templateName: 'i-i-s-pencils-pencil-e'
  });
});
define('ember-app/routes/i-i-s-pencils-pencil-l', ['exports', 'ember-flexberry/routes/list-form'], function (exports, _listForm) {
  'use strict';
  ...
  exports.default = _listForm.default.extend({
    /**
      ...
      @default 'PencilL'
    */
    modelProjection: 'PencilL',

    /**
      Name of model to be used as list's records types.
       @property modelName
      @type String
      @default 'i-i-s-pencils-pencil'
    */
    modelName: 'i-i-s-pencils-pencil',
...
define('ember-app/serializers/i-i-s-pencils-pencil-offline', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-pencils-pencil-offline', 'ember-app/serializers/application-offline'], function (exports, _iISPencilsPencilOffline, _applicationOffline) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _applicationOffline.default.extend(_iISPencilsPencilOffline.OfflineSerializer, {});
});
define('ember-app/serializers/i-i-s-pencils-pencil', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-pencils-pencil', 'ember-app/serializers/application'], function (exports, _iISPencilsPencil, _application) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _application.default.extend(_iISPencilsPencil.Serializer, {
    /**
